...
表格多行可以自由新增、删除、复制每一行的内容，每一行的表单组合相同
...
| draggable | 是否可拖拽 [参考 AddableRow 拖拽用法](/components/addable-row/#components-addable-row-demo-dragable) | Boolean | false |
