        ...
        {uploadUrl ? <div className="hermes-photo-picker-header">
          <div className="hermes-photo-picker-upload">
            <Upload {...this.uploadProps()} >
              {uploadNotice ?
                <Popover placement="topRight" content={uploadNotice}><Button type="ghost" loading={loading}>上传新图片</Button></Popover> :
                <Button type="ghost" loading={loading}>上传新图片</Button>
              }
            </Upload>
          </div>
        </div> : null}
        <div className={`hermes-photo-picker-list ${pagination && pagination.total ? ' hermes-photo-picker-pagination-list' : ''}`} ref={dom => this.picContainer = dom}>
