...
const Clamp = class extends React.Component {
  static propTypes = {
    ...
    ellipsis: PropTypes.oneOfType([PropTypes.string, PropTypes.element]),
    clamp: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
    reverse: PropTypes.bool,
    splitByWords: PropTypes.bool,
    disableCssClamp: PropTypes.bool,
    lineTextLen: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  };
  static defaultProps = {
    ellipsis: '...',
    clamp: 3,
