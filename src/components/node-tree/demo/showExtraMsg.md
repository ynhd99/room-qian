...
title:
  zh-CN: 显示结点外信息
  en-US: Show Extra Message
---

## zh-CN

树状图支持在结点外显示一条文本，它可以是表达父子之间关系的数据或是其它业务所需的信息，通过配置extraMsg属性，我们可以从结点对象中找到对应的值并予以显示，如果不需要的话则缺省extraMsg属性即可。
<br/>
也可以通过showDirectArrow属性来决定是否展示方向箭头。
